...
class SignupForm extends Form {
    ...
    FIELD_ERROR = {
        ...
        PASSWORD: 
        'Пароль повинен складатися з не менше як 8 символів, включаючи цифри, великі і малі літери',
        PASSWORD_AGAIN: 'Другий пароль не збігається з першим',        
        ROLE: 'Ви не обрали роль',
        NOT_CONFIRM: 'Ви не погодилися з правилами сервісу',
    }
